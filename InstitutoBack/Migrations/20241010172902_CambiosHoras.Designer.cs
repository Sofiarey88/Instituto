...
namespace InstitutoBack.Migrations
{
    ...
    [Migration("20241010172902_CambiosHoras")]
    partial class CambiosHoras
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstitutoServices.Models.Commons.AnioCarrera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InstitutoServices.Models.Inscripciones.Inscripcion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CicloLectivoId = 1,
                            Eliminado = false,
                            Fecha = new DateTime(2024, 10, 10, 14, 28, 59, 735, DateTimeKind.Local).AddTicks(1598)
                        });
                });
            ...
            modelBuilder.Entity("InstitutoServices.Models.Horarios.Horario", b =>
                {
                    ...
                    b.Navigation("IntegrantesHorario");
                });
